...
/**
 * Did utils class, some did common tools method implement in this class
 */
public final class DidUtils {
	 ...
	 * @param alternateKeyPair
	 */
	public static BaseDidDocument generateBaseDidDocument(final DidDocument didDocument) throws Exception {
		BaseDidDocument baseDidDocument = new BaseDidDocument();
		baseDidDocument.setContext(CurrencyCode.W3C_FORMAT_ADDRESS);
	 ...
	 * @return
	 */
	public static DidDocument renewDidDocument(DidDocument didDocument, KeyPair keyPair) {
		PublicKey primaryPublicKey = new PublicKey();
