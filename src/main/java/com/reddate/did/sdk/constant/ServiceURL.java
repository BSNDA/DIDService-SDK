...
public class ServiceURL {
	...
	/**
	 * URL of create permission for saved resource(s) in identify HUB service endpoint in BSN
	 * 
	 */
	public static final String HUB_CREATE_PERMISSION = "/hub/createPerm";
	
	/**
	 * URL of delete created permission for saved resource(s) in identify HUB service endpoint in BSN
	 * 
	 */
	public static final String HUB_DELETE_PERMISSION = "/hub/deletePermission";
	
	/**
	 * URL of query created grant for other identify HUB user in identify HUB service endpoint in BSN
	 * 
	 */
	public static final String HUB_QUERY_PERMISSION = "/hub/queryPermission";

	/**
	 * URL of check grant that if one identify HUB user have the grant for the resource in identify HUB service endpoint in BSN
	 * 
	 */
