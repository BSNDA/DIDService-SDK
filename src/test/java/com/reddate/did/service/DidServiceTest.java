...
public class DidServiceTest {
    ...
    public void testGetDidDocument() {
        assertThrows(RuntimeException.class,
                () -> (new DidService("https://example.org/example", "ABC123", "myproject")).getDidDocument("Did"));
        assertThrows(RuntimeException.class, () -> (new DidService("\"", "ABC123", "myproject")).getDidDocument("Did"));
    }
